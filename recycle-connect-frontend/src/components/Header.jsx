        ...
        <Dropdown show={showDropdown} onToggle={() => setShowDropdown(!showDropdown)}>
          ...
          <Dropdown.Menu align="end">
            <Dropdown.Item as={Link} to="/userdata">
              <FaUser className="me-2" /> Dados do Usuário
            </Dropdown.Item>
            <Dropdown.Item as={Link} to="/">
              <FaShareAlt className="me-2" /> Compartilhar App
            </Dropdown.Item>
            <Dropdown.Item as={Link} to="/">
              <FaWhatsapp className="me-2" style={{ color: "green" }} /> Fale Conosco
            </Dropdown.Item>
            <Dropdown.Item as={Link} to="/">
              <FaCog className="me-2" /> Configurações
            </Dropdown.Item>
            <Dropdown.Divider />
            <Dropdown.Item className="text-danger"><FaSignOutAlt className="me-2" /> Sair da Conta
            </Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
